...
typedef int (*map_selector) (const void *data, void *sel_arg, const void *context);
...
typedef int (*map_operator) (void *data, void *op_arg, int *remove, const void *context);
...
struct MAP_CMP_SELECTOR_ARG {
  const int compare_operators;                                                          // The comparison operators to use.
  const void *compare_with;                                                             // The data to compare with, passed to the comparison function as second argument.
  const void *compare_arg;                                                              // An optional argument to pass to the comparison function as third argument.
  int (*comparator) (const void *a, const void *compare_with, const void *compare_arg); // The comparison function.
};
